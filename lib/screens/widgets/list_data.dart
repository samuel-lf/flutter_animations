      ...
      child: Row(
        children: <Widget>[
          ...
          Column(
            ...
            children: <Widget>[
              Text(title, style: TextStyle(fontWeight: FontWeight.w400, fontSize: 18),),
              SizedBox(height: 5,),
              Text(subtitle, style: TextStyle(fontWeight: FontWeight.w300, fontSize: 14, color: Colors.grey),)
            ],
          )
        ],
      ),
